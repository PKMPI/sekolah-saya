        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                ...
                <form action="" method="POST" class="col-md-12 text-right ml-5 mt-2 mb-2">
                    <a href="" class="btn btn-info" data-toggle="modal" data-target="#bd-example-modal-lg"><i class="icon-copy dw dw-user-2"></i> Add New Admin</a>
                </form>
                        ...
                        <tbody>
                            ...
                            foreach ($admin as $a) : ?>
                                <tr>
                                    ...
                                    <td><?= $a['alamat'] ?></td>
                                    <td>
                                        <a href="<?= base_url() . '/aksibtn/delete_admin/' . $a['no_pengenal'] ?>" class="btn btn-danger sm"><i class="icon-copy dw dw-delete-3"></i></a>
                                    </td>
                                <?php endforeach; ?>
                                </tr>
                        </tbody>
                ...
                <div class="modal fade bs-example-modal-lg" id="bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <form class="m-2 p-2 was-validated" action="<?= base_url() ?>/Aksibtn/add_admin" method="POST">
                                <?= csrf_field() ?>
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myLargeModalLabel">Tambah Admin Baru</h4>
